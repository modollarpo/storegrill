...
export function ProductShare({ name, slug, url, className }: ProductShareProps) {
  ...
  const iconButtonClass =
    'w-10 h-10 grid place-items-center rounded-full transition-colors shadow-sm bg-surface border border-border text-text-secondary hover:bg-surface-sunken';
