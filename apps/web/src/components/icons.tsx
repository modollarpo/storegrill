...
export function StarHalf({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 20 20">
      <defs>
        <linearGradient id="half-star" x1="0" x2="100%" y1="0" y2="0">
          <stop offset="50%" stopColor="#de7921" />
          <stop offset="50%" stopColor="#d8d3cb" />
        </linearGradient>
      </defs>
      <path
        fill="url(#half-star)"
...
export function StoregrillLogo({ className = 'h-7' }: IconProps) {
  return (
    <img src="/logo.png" alt="Storegrill" className={className} />
  );
}
