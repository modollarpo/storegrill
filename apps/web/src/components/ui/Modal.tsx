  ...
  return createPortal(
    <div className="fixed inset-0 z-[var(--z-modal)] flex items-end justify-center sm:items-center" role="presentation">
      ...
      <div
        ...
        aria-label={title}
        className={cn(
          'relative bg-white rounded-t-xl sm:rounded-xl shadow-xl w-full sm:max-w-lg max-h-[90vh] overflow-y-auto',
          'animate-slide-up sm:animate-fade-in',
          className
        )}
      >
        {title && (
          <div className="flex items-center justify-between px-5 py-4 border-b border-smoke-150 sticky top-0 bg-white rounded-t-xl">
