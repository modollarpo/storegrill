  ...
  return (
    <main className="container-site min-h-[60vh] flex flex-col items-center justify-center py-20 text-center animate-fade-in">
      <div className="relative mb-8">
        <h1 className="text-8xl md:text-9xl font-black text-surface-900 tracking-tighter opacity-10 select-none">
          404
        </h1>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4">
        ...
        <Link 
          href="/products" 
          className="inline-flex items-center justify-center h-12 px-8 rounded-full bg-surface-100 text-surface-900 font-bold tracking-wide border border-surface-200 hover:bg-surface-200 active:scale-95 transition-all"
        >
          Browse Products
        </Link>
      </div>
