  ...
  return (
    <label htmlFor={id} className={cn('inline-flex items-center gap-2 cursor-pointer select-none group', className)}>
      <span className="relative inline-flex items-center justify-center">
        ...
        <span className="w-4 h-4 rounded-xs border border-smoke-300 bg-white transition-colors peer-checked:bg-ember peer-checked:border-ember peer-focus-visible:shadow-[0_0_0_3px_rgba(255,122,28,0.35)]" />
        <svg
