...
const REGION_SEEDS: RegionSeed[] = [
  { key: 'UK', name: 'United Kingdom', languages: ['en'], currency: 'GBP', timezone: 'Europe/London', taxName: 'VAT', taxRate: 0.20, taxType: 'VAT', shipCountries: ['GB'], baseRateMinorUnits: 1000, perKgRateMinorUnits: 99, thresholdMinorUnits: 3500, daysMin: 1, daysMax: 7, carriers: ['Royal Mail', 'Evri', 'DHL'], paymentMethods: ['card', 'paypal', 'klarna', 'afterpay'] },
